...
**135 identical + one FAIL**: `lib/syntax_demo_test.mc` registers `#infix ".+"`, and
...
* **The default registry is `https://minicompiler.dev/registry`**, not
  `raw.githubusercontent.com/schivei/mc-registry`. The owner decided (2026-09-04) that a package
